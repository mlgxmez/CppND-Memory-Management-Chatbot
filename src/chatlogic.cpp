...
void ChatLogic::LoadAnswerGraphFromFile(std::string filename)
{
                ...
                if (idToken != tokens.end())
                {
                    ...
                    if (type->second == "NODE")
                    {
                        ...
                        // check if node with this ID exists already
                      	// passing unique_ptr as arguments better by reference
                      	// must be shared pointer??
                    ...
                    if (type->second == "EDGE")
                    {
                        ...
                        if (parentToken != tokens.end() && childToken != tokens.end())
                        {
                            ...
                            AddAllTokensToElement("KEYWORD", tokens, *edge); // Pass edge by value
    ...
    // add chatbot to graph root node
  	...
  	ChatBot _demochatBot("../images/chatbot.png");
    _demochatBot.SetChatLogicHandle(this);
    _demochatBot.SetRootNode(rootNode);
  	// TODO: Do that with move semantics
    rootNode->MoveChatbotHere(std::move(_demochatBot));
